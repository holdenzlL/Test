...
def sila_main(
    socketIoServer: socketio = Option(None, "-socketIoServer", "--socketIoServer", help="The client", show_default=None),
    ...
    # run server
    server = Server(server_uuid=parsed_server_uuid, socketIoServer=socketIoServer)
    try:
        if insecure:
