...
from . import ursilainterface


class Client(SilaClient):
    UrSilaInterface: ursilainterface.UrSilaInterfaceClient
    ...
    _expected_features: Set[FullyQualifiedFeatureIdentifier] = {
        ...
        FullyQualifiedFeatureIdentifier("org.silastandard/examples/UrSilaInterface/v1"),
    }
