...
from .feature_implementations.ursilainterface_impl_2 import UrSilaInterfaceImpl
...
class Server(SilaServer):
    def __init__(self, socketIoServer: socketio, server_uuid: Optional[UUID] = None):
        ...
        self.ursilainterface = UrSilaInterfaceImpl(self, socketIoServer=socketIoServer)
